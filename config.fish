...
# Last Change       - Fri 22 Sep 20:09:34 BST 2017
...
if type -P /usr/bin/sudo 2>&1 > /dev/null
	if type -P /usr/bin/vim 2>&1 > /dev/null
		export SUDO_EDITOR="rvim"
	else if type -P /usr/bin/nano 2>&1 > /dev/null
...
if type -P /bin/date /usr/bin/tty 2>&1 > /dev/null
